...
public class DialogHelp {
    ...
    /**
     * 获取一个确认信息对话框，取消按钮不做任何逻辑处理，仅仅是简单的取消，注意需要自己手动调用show方法显示
     * @param context
     * @param message
     * @param onClickListener
     * @return
    ...
    /**
     * 获取一个确认信息对话框，注意需要自己手动调用show方法显示
     * @param context
     * @param messae
     * @param onClickListener
     ...
     * @return
     */
    public static AlertDialog.Builder getConfirmDialog(Context context, String messae, DialogInterface.OnClickListener onClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        AlertDialog.Builder builder = getDialog(context);
